const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/About-DOjIOmE3.js","assets/TrainTrack-B5X6yzwC.js","assets/TrainTrack-sVEUxovV.css","assets/Actions-_gddVYh0.js","assets/lightBulb2-BHDw-1ez.js","assets/HeaderFilter-C8FTdmjN.js","assets/SDGs_goal-BU-5yG0n.js","assets/CJKSub-8TmzHbHM.js","assets/CJKSub-DT0M_kds.css","assets/ActionNew-DPlFSqGn.js","assets/index--6zVJYH6.js","assets/ActionNew-onH3Jp4j.css","assets/ActionDetail-DcrR1Mwf.js","assets/平和國小_mobile_Example-Bsr5Md9p.js","assets/ActionDetail-DwIsiGzF.css","assets/SDGs-BwA0m0UD.js","assets/Story-ByaX6pub.js","assets/useDateFormat-BFMwo5FP.js","assets/Story-DaemCPTX.css","assets/StoryNew-siLfQmrN.js","assets/StoryNew-B1A0VkUn.css","assets/StoryDetail-DWCOrEZo.js","assets/StoryDetail-CMpdjjEh.css"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qr="[DEFAULT]",Sh={[Kr]:"fire-core",[Xd]:"fire-core-compat",[Qd]:"fire-analytics",[Zd]:"fire-analytics-compat",[th]:"fire-app-check",[eh]:"fire-app-check-compat",[nh]:"fire-auth",[sh]:"fire-auth-compat",[rh]:"fire-rtdb",[ih]:"fire-data-connect",[oh]:"fire-rtdb-compat",[ah]:"fire-fn",[ch]:"fire-fn-compat",[lh]:"fire-iid",[uh]:"fire-iid-compat",[fh]:"fire-fcm",[dh]:"fire-fcm-compat",[hh]:"fire-perf",[ph]:"fire-perf-compat",[gh]:"fire-rc",[mh]:"fire-rc-compat",[_h]:"fire-gcs",[yh]:"fire-gcs-compat",[vh]:"fire-fst",[wh]:"fire-fst-compat",[bh]:"fire-vertex","fire-js":"fire-js",[Eh]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $h(t){Yn(new vn("platform-logger",e=>new Jd(e),"PRIVATE")),Yn(new vn("heartbeat",e=>new Dh(e),"PRIVATE")),dn(Kr,Eo,t),dn(Kr,Eo,"esm2020"),dn("fire-js","")}$h("");function Nc(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Fh=Nc,Dc=new as("auth","Firebase",Nc());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zh=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],Kh=new us(3e4,6e4);function Ft(t,e){return t.tenantId&&!e.tenantId?{...e,tenantId:t.tenantId}:e}async function Vt(t,e,n,s,r={}){return Uc(t,r,async()=>{let i={},o={};s&&(e==="GET"?o=s:i={body:JSON.stringify(s)});const a=cs({key:t.config.apiKey,...o}).slice(1),c=await t._getAdditionalHeaders();c["Content-Type"]="application/json",t.languageCode&&(c["X-Firebase-Locale"]=t.languageCode);const l={method:e,headers:c,...i};return _d()||(l.referrerPolicy="no-referrer"),t.emulatorConfig&&ar(t.emulatorConfig.host)&&(l.credentials="include"),Lc.fetch()(await $c(t,t.config.apiHost,n,a),l)})}async function Uc(t,e,n){t._canInitEmulator=!1;const s={...Wh,...e};try{const r=new Gh(t),i=await Promise.race([n(),r.promise]);r.clearNetworkTimeout();const o=await i.json();if("needConfirmation"in o)throw vs(t,"account-exists-with-different-credential",o);if(i.ok&&!("errorMessage"in o))return o;{const a=i.ok?o.errorMessage:o.error.message,[c,l]=a.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw vs(t,"credential-already-in-use",o);if(c==="EMAIL_EXISTS")throw vs(t,"email-already-in-use",o);if(c==="USER_DISABLED")throw vs(t,"user-disabled",o);const u=s[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(l)throw Mc(t,u,l);He(t,u)}}catch(r){if(r instanceof $t)throw r;He(t,"network-request-failed",{message:String(r)})}}async function fs(t,e,n,s,r={}){const i=await Vt(t,e,n,s,r);return"mfaPendingCredential"in i&&He(t,"multi-factor-auth-required",{_serverResponse:i}),i}async function $c(t,e,n,s){const r=`${e}${n}?${s}`,i=t,o=i.config.emulator?Si(t.config,r):`${t.config.apiScheme}://${r}`;return zh.includes(n)&&(await i._persistenceManagerAvailable,i._getPersistenceType()==="COOKIE")?i._getPersistence()._getFinalTarget(o).toString():o}function qh(t){switch(t){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class Gh{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,s)=>{this.timer=setTimeout(()=>s(tt(this.auth,"network-request-failed")),Kh.get())})}}function vs(t,e,n){const s={appName:t.name};n.email&&(s.email=n.email),n.phoneNumber&&(s.phoneNumber=n.phoneNumber);const r=tt(t,e,s);return r.customData._tokenResponse=n,r}function Ro(t){return t!==void 0&&t.enterprise!==void 0}class Jh{constructor(e){if(this.siteKey="",this.recaptchaEnforcementState=[],e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.recaptchaEnforcementState=e.recaptchaEnforcementState}getProviderEnforcementState(e){if(!this.recaptchaEnforcementState||this.recaptchaEnforcementState.length===0)return null;for(const n of this.recaptchaEnforcementState)if(n.provider&&n.provider===e)return qh(n.enforcementState);return null}isProviderEnabled(e){return this.getProviderEnforcementState(e)==="ENFORCE"||this.getProviderEnforcementState(e)==="AUDIT"}isAnyProviderEnabled(){return this.isProviderEnabled("EMAIL_PASSWORD_PROVIDER")||this.isProviderEnabled("PHONE_PROVIDER")}}async function Yh(t,e){return Vt(t,"GET","/v2/recaptchaConfig",Ft(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xo(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Wc(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Hc(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Kc(e))return"Blackberry";if(qc(e))return"Webos";if(Bc(e))return"Safari";if((e.includes("chrome/")||jc(e))&&!e.includes("edge/"))return"Chrome";if(zc(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=t.match(n);if(s?.length===2)return s[1]}return"Other"}function Hc(t=Ie()){return/firefox\//i.test(t)}function Bc(t=Ie()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function jc(t=Ie()){return/crios\//i.test(t)}function Wc(t=Ie()){return/iemobile/i.test(t)}function zc(t=Ie()){return/android/i.test(t)}function Kc(t=Ie()){return/blackberry/i.test(t)}function qc(t=Ie()){return/webos/i.test(t)}function Ci(t=Ie()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function ip(t=Ie()){return Ci(t)&&!!window.navigator?.standalone}function op(){return bd()&&document.documentMode===10}function Gc(t=Ie()){return Ci(t)||zc(t)||qc(t)||Kc(t)||/windows phone/i.test(t)||Wc(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gt{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,n,s,r=!1){const i=await Ue._fromIdTokenResponse(e,s,r),o=Lo(s);return new Gt({user:i,providerId:o,_tokenResponse:s,operationType:n})}static async _forOperation(e,n,s){await e._updateTokensIfNecessary(s,!0);const r=Lo(s);return new Gt({user:e,providerId:r,_tokenResponse:s,operationType:n})}}function Lo(t){return t.providerId?t.providerId:"phoneNumber"in t?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Dp(t,e,n=!1){const{auth:s}=t;if(Le(s.app))return Promise.reject(ht(s));const r="reauthenticate";try{const i=await Zn(t,el(s,r,e,t),n);V(i.idToken,s,"internal-error");const o=Ti(i.idToken);V(o,s,"internal-error");const{sub:a}=o;return V(t.uid===a,s,"user-mismatch"),Gt._forOperation(t,r,i)}catch(i){throw i?.code==="auth/user-not-found"&&He(s,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tl(t,e,n=!1){if(Le(t.app))return Promise.reject(ht(t));const s="signIn",r=await el(t,s,e),i=await Gt._fromIdTokenResponse(t,s,r);return n||await t._updateCurrentUser(i.user),i}async function Mp(t,e){return tl(Yt(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nl(t){const e=Yt(t);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Lp(t,e,n){if(Le(t.app))return Promise.reject(ht(t));const s=Yt(t),o=await Xr(s,{returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",xp).catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&nl(t),c}),a=await Gt._fromIdTokenResponse(s,"signIn",o);return await s._updateCurrentUser(a.user),a}function Up(t,e,n){return Le(t.app)?Promise.reject(ht(t)):Mp(bt(t),In.credential(e,n)).catch(async s=>{throw s.code==="auth/password-does-not-meet-requirements"&&nl(t),s})}function $p(t,e,n,s){return bt(t).onIdTokenChanged(e,n,s)}function Fp(t,e,n){return bt(t).beforeAuthStateChanged(e,n)}function Vp(t,e,n,s){return bt(t).onAuthStateChanged(e,n,s)}function Hp(t){return bt(t).signOut()}const Ks="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nt(){return window}function qp(t){nt().location.href=t}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
